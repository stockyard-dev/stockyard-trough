...
func Open(d string)(*DB,error){if err:=os.MkdirAll(d,0755);err!=nil{return nil,err};db,err:=sql.Open("sqlite",filepath.Join(d,"trough.db")+"?_journal_mode=WAL&_busy_timeout=5000");if err!=nil{return nil,err}
